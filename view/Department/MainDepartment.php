                                ...
                                <tbody>
                                    <?php foreach ($departmentDAO as $department) : ?>
                                        <tr>
                                            ...
                                            <td> <?= $department->getCreatedDepartment(); ?> </td>
                                            <td> <?= $department->getUpdatedDepartment(); ?> </td>
                                            <td>
                                                <div class="d-grid gap-2 d-md-flex justify-content-center">
                                                    <button class="btn btn-dark btn-sm" onclick="window.location.href = 'editar-articulo.php?id=<?= $department->getIdDepartment(); ?>'">
