...
<html lang="es">
    ...
    <body>
        ...
        require_once 'modell/DAO/CustomersDAO.php';

        try {
            $customersDAO = (new CustomersDAO)->ReadAll();
        } catch (Exception $e) {
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="myTable" class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <?php foreach ($customersDAO as $customer) : ?>
                                    <td> 
                                        <div class="d-flex align-items-center">
                                            <img
                                                ...
                                                />
                                            <div class="ms-3">
                                                <p class="fw-bold mb-1"><?= join(' ', [$customer->getNameCustomers(), $customer->getPaternalCustomers(), $customer->getMaternalCustomers()]); ?></p>
                                                <p class="text-muted mb-0"><a href="mailto:<?= $customer->getMailCustomers(); ?>"><?= $customer->getMailCustomers(); ?></a> <?= ' | ' ?> <a href="tel:<?= $customer->getPhoneCustomers(); ?>"><?= $customer->getPhoneCustomers(); ?></a></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td> 
                                        ...
                                        <?= $customer->getCategoryCustomers(); ?> </td>
                                    ...
                                    <td>
                                        <div class="d-grid gap-2 d-md-flex justify-content-center">
                                            ...
                                            <button class="btn btn-danger btn-sm" onclick="eliminarArticulo(<?= $customer->getIdCustomers(); ?>)">
